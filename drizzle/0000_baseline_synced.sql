...
CREATE TYPE "public"."mastery_level" AS ENUM('a_revoir', 'en_cours', 'maitrise');--> statement-breakpoint
...
CREATE TABLE "legal_chunks" (
	"id" serial PRIMARY KEY NOT NULL,
	"source_doc" text DEFAULT 'code_urbanisme' NOT NULL,
	"article_ref" text,
	"title" text,
	"heading_path" text,
...
--> statement-breakpoint
CREATE TABLE "section_legal_refs" (
	"id" serial PRIMARY KEY NOT NULL,
...
ALTER TABLE "challenges" ADD CONSTRAINT "challenges_source_section_id_sections_id_fk" FOREIGN KEY ("source_section_id") REFERENCES "public"."sections"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "section_legal_refs" ADD CONSTRAINT "section_legal_refs_section_id_sections_id_fk" FOREIGN KEY ("section_id") REFERENCES "public"."sections"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "section_legal_refs" ADD CONSTRAINT "section_legal_refs_chunk_id_legal_chunks_id_fk" FOREIGN KEY ("chunk_id") REFERENCES "public"."legal_chunks"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_question_srs" ADD CONSTRAINT "user_question_srs_question_id_challenges_id_fk" FOREIGN KEY ("question_id") REFERENCES "public"."challenges"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_sous_theme_progress" ADD CONSTRAINT "user_sous_theme_progress_sous_theme_id_sous_themes_id_fk" FOREIGN KEY ("sous_theme_id") REFERENCES "public"."sous_themes"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "uqs_user_question_unique" ON "user_question_srs" USING btree ("user_id","question_id");--> statement-breakpoint
CREATE INDEX "uqs_user_due_idx" ON "user_question_srs" USING btree ("user_id","due_at");