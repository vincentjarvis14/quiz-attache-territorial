  ...
  return (
    <div className="mx-auto w-full max-w-md px-4">
      ...
      <Button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 bg-white border border-slate-300 text-slate-700 hover:bg-slate-50 py-6 text-base font-medium shadow-sm mb-6"
      >
        <GoogleIcon />
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="bg-white px-3 text-slate-400">ou par email</span>
        </div>
      </div>
