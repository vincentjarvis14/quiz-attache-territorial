...
const SECTIONS: Section[] = [
  ...
  { numero: "04", href: "/presentation/framework-bmad", titre: "Framework BMAD", tag: "Méthode", Icon: Users, accent: "moss", span: "lg:col-span-3", description: "Le Vibe Coding structuré en équipe d'agents : le rôle de chaque agent (analyste, PM, architecte, dev, QA…) et sa traduction concrète sur le projet." },
  { numero: "05", href: "/presentation/stack", titre: "Stack technique", tag: "Technologie", Icon: Layers, accent: "ink", span: "lg:col-span-2", description: "Next.js 16, Neon, Supabase Auth, Drizzle ORM, Tailwind. Pourquoi ces outils — avec les alternatives considérées et rejetées." },
  { numero: "06", href: "/presentation/architecture", titre: "Architecture", tag: "Technique", Icon: Network, accent: "moss", span: "lg:col-span-2", description: "4 couches applicatives, Route Groups, React Server Components, Server Actions et structure des fichiers explorable." },
  { numero: "07", href: "/presentation/base-de-donnees", titre: "Base de données", tag: "Données", Icon: Database, accent: "ink", span: "lg:col-span-2", description: "15 tables PostgreSQL, schéma Drizzle : contenu pédagogique, progression et RAG urbanisme." },
  { numero: "08", href: "/presentation/rag", titre: "Pipeline RAG", tag: "Intelligence Artificielle", Icon: BrainCircuit, accent: "coral", span: "lg:col-span-3", description: "De 17 PDFs officiels à ~760 questions QCM. Génération Claude Opus offline, plus une recherche juridique live dans le Code de l'urbanisme." },
  { numero: "09", href: "/presentation/fonctionnalites", titre: "Fonctionnalités MVP", tag: "Produit", Icon: LayoutGrid, accent: "ink", span: "lg:col-span-3", description: "Les 6 fonctionnalités livrées et leur correspondance au cahier des charges." },
  { numero: "10", href: "/presentation/couts-tests", titre: "Coûts & tests", tag: "Fiabilité", Icon: Wallet, accent: "moss", span: "lg:col-span-3", description: "Hébergement à 0 €/mois sur offres gratuites (pièges anticipés) et qualité fiabilisée : validation du contenu + 24 tests unitaires." },
  { numero: "11", href: "/presentation/synthese", titre: "Synthèse", tag: "Bilan", Icon: Award, accent: "coral", span: "lg:col-span-3", description: "Ce que ce projet démontre : compétences et MVP déployé." },
]
