...
// Nombre de questions à générer par sous-thème
const QUESTIONS_PER_SOUS_THEME = 23; // 18 sous-thèmes × 23 ≈ 414 questions
// Nombre de leçons par sous-thème
...
async function main() {
  console.log("🤖 Démarrage de la génération des 400+ questions...");
  console.log(`📚 ${QUESTIONS_PER_SOUS_THEME} questions par sous-thème\n`);
  ...
  console.log(`\n🎉 GÉNÉRATION TERMINÉE !`);
  console.log(`📊 Total : ${totalGenerated} questions générées et sauvegardées`);
}
